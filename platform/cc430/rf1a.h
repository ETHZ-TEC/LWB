...
extern void rf1a_cb_header_received(rtimer_clock_t *timestamp, uint8_t *header, uint8_t packet_len);
// reception ended callback
extern void rf1a_cb_rx_ended(rtimer_clock_t *timestamp, uint8_t *pkt, uint8_t pkt_len);
...
// set after how many bytes the MAC/Glossy layer should be notified about a header reception
