...
- [Virtus](https://github.com/ETHZ-TEC/LWB/blob/master/doc/papers/VirtusSRDS13.pdf), a protocol that provides [virtual synchrony](https://en.wikipedia.org/wiki/Virtual_synchrony) in multi-hop low-power wireless networks &mdash; something that was thought to be [impossible](http://www1.cse.wustl.edu/~lu/papers/pieee03.pdf) &mdash; thus enabling dependable applications through replication;
